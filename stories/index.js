...
storiesOf("Appointment", module)
  ...
  .add("Error", () => <Error message="Unable to delete appointment, please try again." onClose={action("onClose")} />)
  .add("Create", () => <Form interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
  .add("Edit", () => <Form name="Kobe" interviewers={interviewers} interviewer={2} onSave={action("onSave")} onCancel={action("onCancel")} />)
